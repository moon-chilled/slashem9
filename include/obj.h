...
#define is_elven_armor(otmp)	((otmp)->otyp == ELVEN_LEATHER_HELM || (otmp)->otyp == ELVEN_MITHRIL_COAT || (otmp)->otyp == ELVEN_CLOAK || (otmp)->otyp == ELVEN_SHIELD || (otmp)->otyp == ELVEN_BOOTS)
#define is_orcish_armor(otmp)	((otmp)->otyp == ORCISH_HELM || (otmp)->otyp == ORCISH_CHAIN_MAIL || (otmp)->otyp == ORCISH_RING_MAIL || (otmp)->otyp == ORCISH_CLOAK || (otmp)->otyp == URUK_HAI_SHIELD || (otmp)->otyp == ORCISH_SHIELD)
#define is_dwarvish_armor(otmp) ((otmp)->otyp == DWARVISH_IRON_HELM || (otmp)->otyp == DWARVISH_MITHRIL_COAT || (otmp)->otyp == DWARVISH_CLOAK || (otmp)->otyp == DWARVISH_ROUNDSHIELD)
...
#define Dragon_scales_to_pm(obj) &mons[PM_GRAY_DRAGON + (obj)->otyp - GRAY_DRAGON_SCALES]
#define Dragon_mail_to_pm(obj)	 &mons[PM_GRAY_DRAGON + (obj)->otyp - GRAY_DRAGON_SCALE_MAIL]
#define Dragon_to_scales(pm)	 (GRAY_DRAGON_SCALES + (pm - mons))

/* Elven gear */
#define is_elven_weapon(otmp) ((otmp)->otyp == ELVEN_ARROW || (otmp)->otyp == ELVEN_SPEAR || (otmp)->otyp == ELVEN_DAGGER || (otmp)->otyp == ELVEN_SHORT_SWORD || (otmp)->otyp == ELVEN_BROADSWORD || (otmp)->otyp == ELVEN_BOW)
#define is_elven_obj(otmp)    (is_elven_armor(otmp) || is_elven_weapon(otmp))

/* Orcish gear */
#define is_orcish_obj(otmp) (is_orcish_armor(otmp) || (otmp)->otyp == ORCISH_ARROW || (otmp)->otyp == ORCISH_SPEAR || (otmp)->otyp == ORCISH_DAGGER || (otmp)->otyp == ORCISH_SHORT_SWORD || (otmp)->otyp == ORCISH_BOW)

/* Dwarvish gear */
#define is_dwarvish_obj(otmp) (is_dwarvish_armor(otmp) || (otmp)->otyp == DWARVISH_SPEAR || (otmp)->otyp == DWARVISH_SHORT_SWORD || (otmp)->otyp == DWARVISH_MATTOCK)
...
#define age_is_relative(otmp) ((otmp)->otyp == BRASS_LANTERN || (otmp)->otyp == OIL_LAMP || (otmp)->otyp == TORCH || (otmp)->otyp == CANDELABRUM_OF_INVOCATION || (otmp)->otyp == TALLOW_CANDLE || (otmp)->otyp == WAX_CANDLE || (otmp)->otyp == POT_OIL)
/* object can be ignited */
#define ignitable(otmp) ((otmp)->otyp == BRASS_LANTERN || (otmp)->otyp == OIL_LAMP || (otmp)->otyp == TORCH || (otmp)->otyp == CANDELABRUM_OF_INVOCATION || (otmp)->otyp == TALLOW_CANDLE || (otmp)->otyp == WAX_CANDLE || (otmp)->otyp == MAGIC_CANDLE || (otmp)->otyp == POT_OIL)
