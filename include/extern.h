...
int get_adjacent_loc(const char *prompt, const char *esmg, xchar x, xchar y, coord * cc);
...
int monhp_per_lvl(struct monst *mon);
...
bool attacktype(struct permonst *, int);
bool poly_when_stoned(struct permonst *);
bool resists_drli(struct monst *);
bool resists_magm(struct monst *);
bool resists_blnd(struct monst *);
bool can_blnd(struct monst *, struct monst *, uchar, struct obj *);
bool ranged_attk(struct permonst *);
bool passes_bars(struct permonst *);
bool can_blow(struct monst *mtmp);
bool can_track(struct permonst *);
bool breakarm(struct permonst *);
bool sliparm(struct permonst *);
bool sticks(struct permonst *);
...
void dotrap(struct trap *trap, unsigned rflags);
