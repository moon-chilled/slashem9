...
#if (defined(ARTILIST_PASS2) && !defined(HAVE_ARTILIST_PASS2)) || (defined(ARTILIST_PASS1) && !defined(HAVE_ARTILIST_PASS1))
...
#if defined(ARTILIST_PASS2) && !defined(HAVE_ARTILIST_PASS2)
# define HAVE_ARTILIST_PASS2
# define A(art_id,nam,typ,s1,s2,mt,atk,dfn,cry,inv,al,cl,rac,cost) art_id

enum {
#elif defined(ARTILIST_PASS1) && !defined(HAVE_ARTILIST_PASS1)
# define HAVE_ARTILIST_PASS1
