...
#define telepathic(ptr)	      	((ptr) == &mons[PM_FLOATING_EYE] || is_mind_flayer(ptr))
...
#define is_bat(ptr)	   	((ptr) == &mons[PM_BAT] || (ptr) == &mons[PM_GIANT_BAT] || (ptr) == &mons[PM_VAMPIRE_BAT])
...
#define cantwield(ptr)	     	(nohands(ptr) || verysmall(ptr) || (ptr)->mlet == S_ANT)
...
#define is_shapeshifter(ptr)	((ptr)->mflags3 & M3_SHAPESHIFTER)
#define is_mplayer(ptr)		(((ptr) >= &mons[PM_ARCHEOLOGIST]) && ((ptr) <= &mons[PM_WIZARD]))
...
#define is_reviver(ptr)		(is_rider(ptr) || \
				 ((ptr)->mlet == S_FUNGUS && (ptr) != &mons[PM_LICHEN]) || (ptr)->mlet == S_TROLL)
...
#define likes_lava(ptr)		((ptr) == &mons[PM_FIRE_ELEMENTAL] || (ptr) == &mons[PM_SALAMANDER])
...
#define nonliving(ptr)		(is_golem(ptr) || is_undead(ptr) || \
				 (ptr)->mlet == S_VORTEX || (ptr) == &mons[PM_MANES])
...
#define made_of_rock(ptr)	((passes_walls(ptr) && thick_skinned(ptr)) || \
				 (ptr) == &mons[PM_STONE_GOLEM] || (ptr) == &mons[PM_STATUE_GARGOYLE])
#define hates_silver(ptr)	(is_were(ptr) || is_vampire(ptr) ||           \
				 is_demon(ptr) || (ptr) == &mons[PM_SHADE] || \
				 ((ptr)->mlet == S_IMP && (ptr) != &mons[PM_TENGU]))
#define mon_hates_silver(mon)	(hates_silver((mon)->data) || is_vampshifter(mon))
...
#define vegan(ptr)		((ptr)->mlet == S_BLOB ||                      \
				 ...
				 ((ptr)->mlet == S_GOLEM && (ptr) != &mons[PM_FLESH_GOLEM] && (ptr) != &mons[PM_FRANKENSTEIN_S_MONSTER] && (ptr) != &mons[PM_LEATHER_GOLEM]) || \
				 noncorporeal(ptr))
...
#define has_blood(ptr)		(!vegetarian(ptr) &&                         \
				 (ptr)->mlet != S_GOLEM && \
				 ((ptr)->mlet != S_BAD_FOOD || (ptr) == &mons[PM_KILLER_TRIPE_RATION]) && \
				 (!is_undead(ptr) || is_vampire(ptr)))

#define befriend_with_obj(ptr, obj) \
	((obj)->oclass == FOOD_CLASS && (is_domestic(ptr) || /* [Tom] Dorothy wants more pets... */ \
