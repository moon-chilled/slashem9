...
extern void mar_print_glyph(int, int, int, int);
...
extern void Gem_display_nhwindow(winid, BOOLEAN_P);
...
extern void Gem_display_file(const char *, BOOLEAN_P);
...
extern char Gem_message_menu(CHAR_P,int,const char *);
...
#endif
extern void Gem_print_glyph(winid,XCHAR_P,XCHAR_P,int);
...
extern char Gem_yn_function(const char *, const char *, CHAR_P);
