...
/* ### winmisc.c ### */
extern void ps_key(Widget, XEvent*, String*, Cardinal*); /* player selection action */
extern void race_key(Widget, XEvent*, String*, Cardinal*); /* race selection action */
...
#ifdef GRAPHIC_TOMBSTONE
extern void X11_outrip(winid,int);
#else
