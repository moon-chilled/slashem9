...
static int
	set_glyph_mapping_monsters(glyph) int glyph;
{
	int i, j;
...
static void
	get_glyph_mapping_monsters(map) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
{
	int i, j, k, l;
...
static int
	set_glyph_mapping_invisible_monster(glyph) int glyph;
{
...
static void
	get_glyph_mapping_invisible_monster(map) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
{
	map->flags = "";
	map->base_mapping = -1;
	map->alt_glyph = NO_GLYPH;
...
static int
	set_glyph_mapping_monsters_based(base_glyphs, glyph, type) int base_glyphs,
	glyph, type;
{
	int i;
	switch (type) {
...
static void
	get_glyph_mapping_monsters_based(map, base, type) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
int base, type;
{
	int i;
	switch (type) {
...
static int
	set_glyph_mapping_monster_corpses(base_glyphs, glyph) int base_glyphs,
	glyph;
{
	int i;
	for (i = 0; i < base_glyphs; i++)
...
static void
	get_glyph_mapping_monster_corpses(map, base) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
int base;
{
	map->flags = "corpse";
	map->base_mapping = base;
...
static int
	set_glyph_mapping_objects(glyph) int glyph;
{
	int i, j;
...
static void
	get_glyph_mapping_objects(map) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
{
	int i, j, k, l;
	map->flags = "";
	map->base_mapping = -1;
...
static int
	set_glyph_mapping_cmap_submapping(first, next, glyph) int first,
	next, glyph;
{
	int i;
...
static void
	get_glyph_mapping_cmap_submapping(submap, desc, first, next) struct nhproxy_cb_get_glyph_mapping_res_submapping *submap;
char *desc;
int first, next;
{
	int i;
...
static int
	set_glyph_mapping_cmap(glyph) int glyph;
{
	int i, j, k, l;
	...
	for (i = 0; /* i <= CMAP_NO_GROUP */; i++) {
		...
		l = i == CMAP_NO_GROUP ?
			    MAXPCHARS - MAXEXPCHARS :
			    cmap_idx[i].first_cmap;
		if (l != k)
...
static void
	get_glyph_mapping_cmap(map) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
{
	int i, j, k, l;
	map->flags = "";
	map->base_mapping = -1;
...
static int
	set_glyph_mapping_explosions(glyph) int glyph;
{
	int i, j;
...
static void
	get_glyph_mapping_explosions(map, base) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
int base;
{
	int i, j;
...
static int
	set_glyph_mapping_zaps(glyph) int glyph;
{
	int i, j;
	for (i = 0; i < NUM_ZAP; i++)
		for (j = 0; j < 4; j++)
...
static void
	get_glyph_mapping_zaps(map, base) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
int base;
{
	int i, j;
...
static int
	set_glyph_mapping_swallow(base_glyphs, glyph) int base_glyphs,
	glyph;
{
	int i, j;
...
static void
	get_glyph_mapping_swallow(map, base) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
int base;
{
	int i;
	map->flags = "";
...
static int
	set_glyph_mapping_warning(glyph) int glyph;
{
	int i;
...
static void
	get_glyph_mapping_warning(map) struct nhproxy_cb_get_glyph_mapping_res_mapping *map;
{
	int i;
	map->flags = "";
	map->base_mapping = -1;
...
void
	free_glyph_mapping(mapping) struct nhproxy_cb_get_glyph_mapping_res *mapping;
{
	int i, j;
	for (i = 0; i < mapping->n_mappings; i++) {
